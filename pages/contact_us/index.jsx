            ...
            {formSubmitted ? (
              <div className="text-5xl text-green-500 font-semibold flex items-center flex-col">
                ...
                <button
                  ...
                  className="text-xl mt-4 text-black rounded-xl border-2 px-4 py-1 cursor-pointer hover:text-white hover:border-white hover:bg-black transition-all duration-200 border-black"
                >
                  Refill Form
                </button>
              </div>
